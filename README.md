...
This is a sample template for codemule_lambdas - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name codemule_lambdas --query 'Stacks[].Outputs'
```
